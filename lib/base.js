...
class MusicBase {
  ...
  static get Chords() {
    ...
    return [
      ...
      // major
      { name: 'major',     abbreviations: ['M', 'maj', ''], intervals: ['M3', 'm3'] },
      { name: 'major 6th', abbreviations: ['M6', 'maj6'], intervals: ['M3', 'm3', 'M2'] },
      { name: 'major 6/9', abbreviations: ['6/9', 'M6/9', 'maj6/9'], intervals: ['M3', 'm3', 'M2', 'P4'] },
      { name: 'major 7th', abbreviations: ['M7', 'maj7'], intervals: ['M3', 'm3', 'M3'] },
      { name: 'major 9th', abbreviations: ['M9', 'maj9'], intervals: ['M3', 'm3', 'M3', 'm3'] },
      { name: 'major 11th', abbreviations: ['M11', 'maj11'], intervals: ['M3', 'm3', 'M3', 'm3', 'm3'] },
      { name: 'major 13th', abbreviations: ['M13', 'maj13'], intervals: ['M3', 'm3', 'M3', 'm3', 'm3', 'M3'] },

      // minor
      { name: 'minor', abbreviations: ['m', 'min'], intervals: ['m3', 'M3']  },
      { name: 'minor 6th', abbreviations: ['m6', 'min6'], intervals: ['m3', 'M3', 'M2'] },
      { name: 'minor 7th', abbreviations: ['m7', 'min7'], intervals: ['m3', 'M3', 'm3'] },
      { name: 'minor 9th', abbreviations: ['m9', 'min9'], intervals: ['m3', 'M3', 'm3', 'M3'] },
      { name: 'minor 11th', abbreviations: ['m11', 'min11'], intervals: ['m3', 'M3', 'm3', 'M3', 'm3'] },
      { name: 'minor 13th', abbreviations: ['m13', 'min13'], intervals: ['m3', 'M3', 'm3', 'M3', 'm3', 'M3'] },
      { name: 'minor major 7th', abbreviations: ['mM7', 'min maj7th', 'm maj7th'], intervals: ['m3', 'M3', 'M3'] },
  ...
  static get Scales() {
    return [
      { name: 'major', abbreviations: ['M', 'maj'], intervals: ['M2', 'M2', 'm2', 'M2', 'M2', 'M2', 'm2'] },
      { name: 'minor', abbreviations: ['m', 'min'], intervals: ['M2', 'm2', 'M2', 'M2', 'm2', 'M2', 'M2'] },
      { name: 'whole', abbreviations: ['whole-tone'], intervals: ['M2', 'M2', 'M2', 'M2', 'M2', 'M2', 'M2'] },
      { name: 'half-whole', abbreviations: ['half-whole'], intervals: ['m2', 'M2', 'm2', 'M2', 'm2', 'M2', 'm2'] },
      { name: 'whole-half', abbreviations: ['whole-half'], intervals: ['M2', 'm2', 'M2', 'm2', 'M2', 'm2', 'M2'] },
    ];
